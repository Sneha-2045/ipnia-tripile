...
const TravelEcosystem = () => {
  ...
  return (
    <PageShell>
      <SEO
        title="IPNIA Travel Ecosystem — One Platform. Every Journey."
        ...
        path="/travel-ecosystem"
        keywords="IPNIA travel ecosystem, business travel India, China business tours, education travel, pilgrimage tours, forex travel"
        image="/assets/ipnia/china-business-tour.jpg"
        jsonLd={jsonLd}
      />
...
export default TravelEcosystem;
